...
#predicting the output for a fresh file
# Importing the dataset
datasetnew = pd.read_csv('C:/Users/GOELMA7/OneDrive - Novartis Pharma AG/Desktop/50_Startups.csv')
X_New = datasetnew
print(X_New)
...
datasetnew['predicted_output'] = y_pred_new
print(datasetnew)

df1 = pd.DataFrame(datasetnew)

# Write the DataFrame to a new CSV file
df1.to_csv('output_data.csv', index=False)
df1.to_csv('C:/Users/GOELMA7/OneDrive - Novartis Pharma AG/Desktop/50_Startups_output1.csv', index=False)
